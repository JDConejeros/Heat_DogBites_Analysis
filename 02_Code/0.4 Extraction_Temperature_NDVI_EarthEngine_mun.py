...
Period: 2019-01-01 to 2025-12-31 (inclusive)
Coverage: All communes of Chile
...
download the CSV files to 01_Input/climate/ and merge them manually.
"""
...
data_out = "01_Input/district_geo/"
...
if os.path.exists(shapefile_path):
    ...
    # Option 2: Shapefile must be created by R script first
    print("Shapefile not found.")
    print("Run 02_Code/0.4 Create_district_geo.R first (requires R, chilemapas, sf, dplyr).")
    ...
    if os.path.exists(shapefile_path):
        ...
        raise FileNotFoundError(
            ...
            "Run 02_Code/0.4 Create_district_geo.R first to create it (all Chile communes)."
        )
...
# Date range (end_date is exclusive in Earth Engine filterDate)
start_date = '2019-01-01'
end_date = '2026-01-01'  # Includes 31/12/2025
